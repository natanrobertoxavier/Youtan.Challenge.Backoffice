...
$(function() {
    ...
    $('#sweet_success').on('click', function () {
        let customTitle = $(this).data('title') || "Good job!";
        let customText = $(this).data('text') || "You clicked the button";
    ...
    $('#sweet_combine').on('click', function () {
        let customTitle = "Good job!";
        let customText = "You clicked the button";
        let customTitleConfirm = "You clicked the button";
        ...
        swal({
            ...
            cancelButtonText: "Nao, continuar com cadastro",
            closeOnConfirm: false,
            closeOnCancel: true
        },
            function (isConfirm) {
